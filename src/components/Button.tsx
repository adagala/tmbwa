  ...
  variants: {
    variant: {
      primary: [
        ...
        // hover color
        'hover:bg-guardsman-red-500 dark:hover:bg-guardsman-red-600',
        // disabled
        'disabled:bg-guardsman-red-100 disabled:text-gray-400',
        'disabled:dark:bg-guardsman-red-800 disabled:dark:text-guardsman-red-400',
      ],
      secondary: [
        // border
