  ...
  return (
    <div
      className={cx(
        ...
        // checked
        'group-data-[state=checked]:border-0 group-data-[state=checked]:border-transparent group-data-[state=checked]:bg-guardsman-red-600',
        // disabled
  ...
  return (
    <RadioGroupPrimitives.Item
      ...
      className={cx(
        ...
        'data-[state=checked]:border-guardsman-red-600 data-[state=checked]:dark:border-guardsman-red-600',
        focusInput,
        className,
      )}
      {...props}
